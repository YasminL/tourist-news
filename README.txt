...
Some specific comments to the code base: 
- HomeCellViewModel and imageURL picks the first multimedia object at the moment. In the future, it would be nice to show all images